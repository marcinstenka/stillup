        ...
        <>
            ...
            <div className='mentors-mobile'>
                ...
                <div className="mentor">
                    ...
                    <div className="mentor__description">
                        <p className='description__short'>ur. 27 czerwca 1988 r. w Szczecinie. Przez pierwsze 7 lat mieszkał w Świdninie, a następnie w Lęborku. Przedsiębiorca z powołania, otwarty umysł, praktyk biznesu, który rozwinął firmę Direct Call od zera do ponad 100 pracowników. Współwłaściciel Pomorskiej Grupy Fotowoltaicznej, po godzinach DJ Oscar Lloyd w nocnych klubach, a prywatnie - mąż i ojciec.</p>
                        <p className='description__read-more'>(czytaj dalej)</p>
