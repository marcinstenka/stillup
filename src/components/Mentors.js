            ...
            <div className='mentors-mobile'>
                ...
                <div className="mentor">
                    ...
                    <div className="mentor__description">
                        ...
                        <p className='description__read-more'>(czytaj dalej)</p>
                        <p className='description__full'><br />Fascynacji słowem towarzyszyła pasja do tworzenia filmów krótkometrażowych, która zaowocowała dyplomem Akademii Filmu i Telewizji w Warszawie w 2017 roku na kierunku montaż filmowy. Zrealizował etiudy w konwencji refleksyjno-satyrycznej  ("Niedowład", "Tramwaj, któremu było smutno", "Poezja", "Psychoanalityk", "Wiosna", "Homo XXI", "Deadline"), pokazujące paradoksy i absurdy ludzkiej egzystencji. "Psychonalityk" dostał się do 10 najlepszych filmów polskiej sekcji Sundance Channel Festiwal w 2015 roku. W latach 2013-2015 współtworzył magazyn wędkarski "Wędrówki z wędką", zwracający uwagę na piękno polskiej przyrody.<br /><br />Największym wyzwaniem zawodowym i przygodą życia była współpraca operatorsko-montażowa przy filmie dokumentalnym "Nieletni inżynierowie"(2019) w reżyserii Aleksandry Skowron i Hanny Polak, opowiadającym o tym, co może się stać, gdy grupa "zwykłych" nastolatków trafi na charyzmatycznego nauczyciela. Magiczna historia rozbudzania potencjału, drzemiącego w każdym młodym człowieku, została zakwalifikowana na kilka znaczących międzynarodowych festiwali filmowych (m.in. Docs Against Gravity, Satisfied Eye, Zlin Film Festiwal).</p>
                        <p className='description__read-less'>(czytaj mniej)</p>
                    </div>
                </div>
            </div>
